...
打开 `outputs/daily_application_workbench.html`，可使用岗位雷达、候选池、每日 5 家投递包和进度看板。岗位雷达支持上传、拖拽或粘贴多张招聘图片，在浏览器内识别企业、岗位、地点和截止时间；首次识别需要联网加载中英文 OCR 模型。社交媒体线索必须补充并确认官方招聘网址后，才会进入候选池和每日排程。
